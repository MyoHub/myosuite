# USAGE
# ./train_myosuite_suits.sh biomechanics         # runs natively
# ./train_myosuite_suits.sh biomechanics local    # use local launcher
# ./train_myosuite_suits.sh biomechanics slurm    # use slurm launcher
