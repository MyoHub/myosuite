...
def train_loop(job_data) -> None:
    ...
    if job_data.job_name == "checkpoint.pt":
        foldername = os.path.join(
            ...
            f"baseline_SB3/myoChal24/{job_data.env}",
        )
        ...
        if os.path.isfile(file_path):
            ...
            raise FileNotFoundError(
                f"No file found at the specified path: {file_path}. See https://github.com/MyoHub/myosuite/blob/dev/myosuite/agents/README.md to download one."
            )
    else:
