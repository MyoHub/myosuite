...
class TestMyo(TestEnvs):
    def test_myo(self):
        ...
        # env_names+="myoSarcHandBaodingFixed-v1, myoFatiHandBaodingFixed-v1, myoReafHandBaodingFixed-v1, myoSarcHandBaodingRandom-v1, myoFatiHandBaodingRandom-v1, myoReafHandBaodingRandom-v1, myoSarcHandBaodingFixed4th-v1, myoFatiHandBaodingFixed4th-v1, myoReafHandBaodingFixed4th-v1, myoSarcHandBaodingFixed8th-v1, myoFatiHandBaodingFixed8th-v1, myoReafHandBaodingFixed8th-v1".split(", ")
