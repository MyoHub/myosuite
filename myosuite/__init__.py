...
myosuite_myobase_suite = (
    set(gym_registry_specs().keys()) - myosuite_env_suite - _current_gym_envs
)
...
import myosuite.envs.myo.myoedits # noqa
myosuite_myoedits_suite = set(gym_registry_specs().keys())-myosuite_env_suite-_current_gym_envs
myosuite_env_suite  = myosuite_env_suite | myosuite_myoedits_suite
myosuite_myoedits_suite = sorted(myosuite_myoedits_suite)
