...
class MyoSkeletonTorque:
    ...
    def _add_motor_actuators(self, spec: MjSpec) -> MjSpec:
        ...
        motor_configs = [
            # Lumbar motors
            ("L5_S1_Flex_Ext", "lumbar_extension", 160),
            ("L5_S1_Lat_Bending", "lumbar_bending", 160),
            ("L5_S1_axial_rotation", "lumbar_rotation", 100),
            ("L4_L5_Flex_Ext", "lumbar_extension", 160),
            ("L4_L5_Lat_Bending", "lumbar_bending", 160),
            ("L4_L5_axial_rotation", "lumbar_rotation", 100),
            ("L3_L4_Flex_Ext", "lumbar_extension", 160),
            ("L3_L4_Lat_Bending", "lumbar_bending", 160),
            ("L3_L4_axial_rotation", "lumbar_rotation", 100),
            ("L2_L3_Flex_Ext", "lumbar_extension", 160),
            ("L2_L3_Lat_Bending", "lumbar_bending", 160),
            ("L2_L3_axial_rotation", "lumbar_rotation", 100),
            ("L1_L2_Flex_Ext", "lumbar_extension", 160),
            ("L1_L2_Lat_Bending", "lumbar_bending", 160),
            ("L1_L2_axial_rotation", "lumbar_rotation", 100),
            ("L1_T12_Flex_Ext", "lumbar_extension", 160),
            ("L1_T12_Lat_Bending", "lumbar_bending", 160),
            ("L1_T12_axial_rotation", "lumbar_rotation", 100),
            # Right arm motors
