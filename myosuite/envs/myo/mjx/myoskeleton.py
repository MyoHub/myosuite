...
class MyoSkeletonTorque:
    ...
    def _apply_spec_changes(self, spec: MjSpec) -> MjSpec:
        ...
        if self._disable_fingers:
            for j in spec.joints:
                if j.name in self.finger_and_hand_joints:
                    j.delete()
    ...
    def _add_motor_actuators(self, spec: MjSpec) -> MjSpec:
        ...
        motor_configs = [
            # Lumbar motors
            ("mot_L5_S1_Flex_Ext", "L5_S1_Flex_Ext", 160),
            ("mot_L5_S1_Lat_Bending", "L5_S1_Lat_Bending", 160),
            ("mot_L5_S1_axial_rotation", "lumbar_rotation", 100),
            ("mot_L4_L5_Flex_Ext", "L4_L5_Flex_Ext", 160),
            ("mot_L4_L5_Lat_Bending", "L4_L5_Lat_Bending", 160),
            ("mot_L4_L5_axial_rotation", "L4_L5_axial_rotation", 100),
            ("mot_L3_L4_Flex_Ext", "L3_L4_Flex_Ext", 160),
            ("mot_L3_L4_Lat_Bending", "L3_L4_Lat_Bending", 160),
            ("mot_L3_L4_axial_rotation", "L3_L4_axial_rotation", 100),
            ("mot_L2_L3_Flex_Ext", "L2_L3_Flex_Ext", 160),
            ("mot_L2_L3_Lat_Bending", "L2_L3_Lat_Bending", 160),
            ("mot_L2_L3_axial_rotation", "L2_L3_axial_rotation", 100),
            ("mot_L1_L2_Flex_Ext", "L1_L2_Flex_Ext", 160),
            ("mot_L1_L2_Lat_Bending", "L1_L2_Lat_Bending", 160),
            ("mot_L1_L2_axial_rotation", "L1_L2_axial_rotation", 100),
            ("mot_L1_T12_Flex_Ext", "L1_T12_Flex_Ext", 160),
            ("mot_L1_T12_Lat_Bending", "L1_T12_Lat_Bending", 160),
            ("mot_L1_T12_axial_rotation", "L1_T12_axial_rotation", 100),
            # Right arm motors
