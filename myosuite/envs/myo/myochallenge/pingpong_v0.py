...
class PingPongEnvV0(BaseV0):
    ...
    def _setup(self,
        ...
        self.paddle_sid = self.sim.model.site_name2id("S_grasp")
    ...
    def get_obs_dict(self, sim):
        ...
        obs_dict['body_qpos'] = sim.data.qpos[:-7].copy()
        obs_dict['body_qvel'] = sim.data.qvel[:-6].copy()*self.dt
        ...
        #obs_dict['goal_pos'] = sim.data.site_xpos[self.goal_sid] How should we specify the goal of the table? 
    ...
    def get_reward_dict(self, obs_dict):
        ...
        rwd_dict = collections.OrderedDict((
            ...
            # Must keys
            ('act_reg', -1.*act_mag),
            ('solved', 0), ### FILL IN THE TOUCH CONDITION FOR THE OTHER END OF TABLE
            ('done', self._get_done(ball_pos[-1])),
        ))
