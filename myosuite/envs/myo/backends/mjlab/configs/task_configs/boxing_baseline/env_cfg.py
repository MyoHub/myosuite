...
from mjlab.envs.mdp.actions import JointVelocityActionCfg, JointPositionActionCfg, TendonEffortActionCfg
...
from myosuite.envs.myo.backends.mjlab.configs.asset_configs.muscle_mimic_body.full_body_constants import get_full_body_cfg
from mjlab.tasks.velocity import mdp
from mjlab.envs.mdp import dr
from mjlab.utils.noise import UniformNoiseCfg as Unoise
from mjlab.sensor import ContactMatch, ContactSensorCfg, TerrainHeightSensorCfg
...
def stand_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  rewards = {
    ...
    "joint_acc_l2": RewardTermCfg(func=mdp.joint_acc_l2, weight=-2.5e-9, params={"asset_cfg":  SceneEntityCfg("human", joint_names=(".*",))}),
    "joint_pos_limits": RewardTermCfg(func=mdp.joint_pos_limits, weight=-0.2, params={"asset_cfg":  SceneEntityCfg("human", joint_names=(".*",))} ),
  ...
  metrics = {"mean_activation": MetricsTermCfg(
  ...
  terminations = {
    ...
    "head_height": TerminationTermCfg(
      ...
      params={"asset_cfg": SceneEntityCfg("human", body_names=(".*head")), "minimum_height": 1.35},
    ),
  }
