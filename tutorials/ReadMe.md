...
- [Playback Opensim Mot Files](./10_PlaybackMotFile.ipynb). This tutorial shows how to load OpenSim Mot files and playback them on the MyoSkeleton (follow the instructions prompted by `python -m myosuite_init`)

*For those tutorial, `mjrl` and `gym==0.13` are needed. You can install them with `pip install tabulate matplotlib torch gym==0.13`
